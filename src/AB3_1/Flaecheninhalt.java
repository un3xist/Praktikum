...
public class Flaecheninhalt {
	...
	public static void main(String[] args) {
		...
		/*
		 * switch(index){ case 1: flaecheninhalt = x*x*Math.PI; break; case 2:
		 * flaecheninhalt = x*x; break; case 3: flaecheninhalt =
		 * (x*x*Math.sqrt(3))/4; break; default: flaecheninhalt = -1; break; }
		 */
